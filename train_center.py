...
from model import FaceModelCenter
from models.inception_resnetv1 import inceptionresnet_v1
...
parser.add_argument('--lr-decay', default=0.1, type=float, metavar='LRD',
                    help='learning rate decay ratio (default: 0.1')
...
def main():
    ...
    model = FaceModelCenter(inceptionresnet_v1, embedding_size=args.embedding_size,num_classes=len(train_dir.classes)
