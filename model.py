...
class FaceModel(nn.Module):
    def __init__(self, backbone, embedding_size, num_classes ):
        ...
        self.model.base = backbone()

        self.embedding_size = embedding_size

        self.model.fc = nn.Linear(1792, self.embedding_size)
...
class FaceModelCenter(nn.Module):
    def __init__(self, backbone, embedding_size, num_classes, checkpoint=None):
        super(FaceModelCenter, self).__init__()
        self.model = nn.Sequential()
        self.model.base = backbone()
        self.model.fc = nn.Linear(1792, embedding_size)
